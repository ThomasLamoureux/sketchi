...
class ChannelsFrame(ctk.CTkFrame):
    ...
    def select_channel(self, channel):
        self.app.active_channel = channel
        self.show_channels()
...
class SketchiApp(ctk.CTk):
    def __init__(self):
        ...
        self.logo_image_path = "sketchi_logo.png"
        self.animation_video_path = "loading_screen.mp4"
        ...
        self.messages = [
            {"sender": "You", "text": "Hello! This is a test message"},
            {"sender": "You", "text": "Another message here"}
        ]
    ...
    def send_message(self, event=None):
        ...
        if text:
            self.messages.append({"sender": "You", "text": text})
